...
{
    /// <summary>
    /// Возвращает поисковые подсказки с историей поиска гостя
    /// </summary>
    public class GetSearchSuggestionsWithGuestSearchHistoryRequestHandler : IRequestHandler<
        GetSearchSuggestionsWithGuestSearchHistoryRequest, GetSearchSuggestionsWithSearchHistoryResponse>
    {
        private readonly ISearchHistoryService _searchHistoryService;
        private readonly ISuggestionsService _suggestionsService;

        public GetSearchSuggestionsWithGuestSearchHistoryRequestHandler(ISuggestionsService suggestionsService,
        ...
        public async Task<GetSearchSuggestionsWithSearchHistoryResponse> Handle(
            GetSearchSuggestionsWithGuestSearchHistoryRequest request, CancellationToken cancellationToken)
        {
            var suggestionsTask = _suggestionsService.GetSearchSuggestions(request.SearchString);
            var searchHistoryTask = _searchHistoryService.GetGuestSearchHistoryFiltered(request.GuestId, request.SearchString);
